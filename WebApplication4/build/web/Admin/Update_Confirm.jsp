            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <form action="ThemSanPham?action=edit&id=${requestScope.id}" method="post"  leng="vi">
                            <table class="table table-bordered table-hover" border="1" cellpadding="5" style="max-width: 100%;">
                                <tr>
                                    <td>Mã sản phẩm</td>
                                    <td><input name="code" value="${requestScope.shoes.getCode()}" style="width: 400px;"></td>
                                </tr>
                                <tr>
                                    <td>Tên sản phẩm</td>
                                    <td><input name="name" value="${requestScope.shoes.getName()}" style="width: 400px;"></td>
                                </tr>
                                <tr>
                                    <td>Nhãn hàng</td>
                                    <td><input name="brand" value="${requestScope.shoes.getBrand()}" style="width: 400px;"></td>
                                </tr>
                                <tr>
                                    <td>Giá sản phẩm</td>
                                    <td><input name="price" value="${requestScope.shoes.getPrice()==0?"":requestScope.shoes.getPrice()}" style="width: 400px;"></td>
                                </tr>
                                <tr>
                                    <td>Phân Loại</td>
                                    <td><input name="type" value="${requestScope.shoes.getType()}" style="width: 400px;"></td>
                                </tr>
                                <tr>
                                    <td>Đối tượng</td>
                                    <td><input name="object" lang="en" value="${requestScope.shoes.getObject()}" style="width: 400px;"></td>
                                </tr>
                                <tr>
                                    <td>Hình ảnh</td>
                                    <td><input name="image" value="${requestScope.shoes.getImage()}" style="width: 400px;"></td>
                                </tr>
                            </table>
